...
## FR-01.1 - Nhập điểm đi

| Test Case ID | Test Type | Test Scenario | Test Case | Preconditions | Test Steps | Test Data | Expected Status | Expected Result | Priority |
|---|---|---|---|---|---|---|---|---|---|
| TC-FR011-001 | Positive | Nhập điểm đi hợp lệ | Nhập địa chỉ điểm đón hợp lệ | Khách hàng đang thực hiện đặt xe | 1. Nhập điểm đi<br>2. Gửi yêu cầu | pickup.address = "Đại học Công nghiệp TP.HCM" | 200 | Hệ thống chấp nhận điểm đi | High |
| TC-FR011-002 | Negative | Nhập điểm đi không hợp lệ | Nhập địa chỉ không tồn tại | Khách hàng đang thực hiện đặt xe | 1. Nhập điểm đi<br>2. Gửi yêu cầu | pickup.address = "@@@###" | 400 | Hệ thống từ chối điểm đi và thông báo lỗi | High |
| TC-FR011-003 | Empty | Không nhập điểm đi | Để trống thông tin điểm đón | Khách hàng đang thực hiện đặt xe | 1. Không nhập điểm đi<br>2. Gửi yêu cầu | pickup = {} | 400 | Hệ thống yêu cầu nhập điểm đi | High |
| TC-FR011-004 | Boundary | Điểm đi đạt giới hạn độ dài | Nhập địa chỉ có độ dài tại giới hạn cho phép | Khách hàng đang thực hiện đặt xe | 1. Nhập địa chỉ<br>2. Gửi yêu cầu | Chuỗi địa chỉ ở giới hạn tối đa | 200 | Hệ thống xử lý dữ liệu thành công | Medium |
| TC-FR011-005 | Error | Sai kiểu dữ liệu | Gửi điểm đi không đúng kiểu dữ liệu | Khách hàng đang thực hiện đặt xe | 1. Gửi request<br>2. Kiểm tra kết quả | pickup = "Đại học" | 400 | Hệ thống trả về lỗi dữ liệu không hợp lệ | Medium |

## FR-01.2 - Nhập điểm đến

| Test Case ID | Test Type | Test Scenario | Test Case | Preconditions | Test Steps | Test Data | Expected Status | Expected Result | Priority |
|---|---|---|---|---|---|---|---|---|---|
| TC-FR012-001 | Positive | Nhập điểm đến hợp lệ | Nhập địa chỉ điểm đến hợp lệ | Khách hàng đang thực hiện đặt xe | 1. Nhập điểm đến<br>2. Gửi yêu cầu | destination.address = "Sân bay Tân Sơn Nhất" | 200 | Hệ thống chấp nhận điểm đến | High |
| TC-FR012-002 | Negative | Nhập điểm đến không hợp lệ | Nhập địa chỉ không tồn tại | Khách hàng đang thực hiện đặt xe | 1. Nhập điểm đến<br>2. Gửi yêu cầu | destination.address = "@@@###" | 400 | Hệ thống từ chối điểm đến | High |
| TC-FR012-003 | Empty | Không nhập điểm đến | Để trống thông tin điểm đến | Khách hàng đang thực hiện đặt xe | 1. Không nhập điểm đến<br>2. Gửi yêu cầu | destination = {} | 400 | Hệ thống yêu cầu nhập điểm đến | High |
| TC-FR012-004 | Boundary | Điểm đến đạt giới hạn độ dài | Nhập địa chỉ tại giới hạn cho phép | Khách hàng đang thực hiện đặt xe | 1. Nhập địa chỉ<br>2. Gửi yêu cầu | Chuỗi địa chỉ ở giới hạn tối đa | 200 | Hệ thống xử lý dữ liệu thành công | Medium |
| TC-FR012-005 | Error | Sai kiểu dữ liệu | Gửi điểm đến không đúng kiểu | Khách hàng đang thực hiện đặt xe | 1. Gửi request<br>2. Kiểm tra kết quả | destination = 12345 | 400 | Hệ thống trả về lỗi dữ liệu | Medium |

## FR-01.3 - Chọn loại xe

| Test Case ID | Test Type | Test Scenario | Test Case | Preconditions | Test Steps | Test Data | Expected Status | Expected Result | Priority |
|---|---|---|---|---|---|---|---|---|---|
| TC-FR013-001 | Positive | Chọn loại xe hợp lệ | Chọn loại xe được hỗ trợ | Khách hàng đang thực hiện đặt xe | 1. Chọn loại xe<br>2. Gửi yêu cầu | vehicleType = "CAR" | 200 | Hệ thống chấp nhận loại xe | High |
| TC-FR013-002 | Negative | Loại xe không được hỗ trợ | Nhập loại xe không tồn tại | Khách hàng đang thực hiện đặt xe | 1. Nhập loại xe<br>2. Gửi yêu cầu | vehicleType = "PLANE" | 400 | Hệ thống từ chối loại xe | High |
| TC-FR013-003 | Empty | Không chọn loại xe | Để trống loại xe | Khách hàng đang thực hiện đặt xe | 1. Không chọn loại xe<br>2. Gửi yêu cầu | vehicleType = "" | 400 | Hệ thống yêu cầu chọn loại xe | High |
| TC-FR013-004 | Boundary | Loại xe có giá trị biên | Nhập giá trị tại giới hạn cho phép | Khách hàng đang thực hiện đặt xe | 1. Nhập loại xe<br>2. Gửi yêu cầu | vehicleType = giá trị hợp lệ dài nhất | 200 | Hệ thống xử lý dữ liệu thành công | Medium |
| TC-FR013-005 | Error | Sai kiểu dữ liệu loại xe | Gửi loại xe bằng kiểu dữ liệu khác | Khách hàng đang thực hiện đặt xe | 1. Gửi request<br>2. Kiểm tra kết quả | vehicleType = 123 | 400 | Hệ thống trả về lỗi dữ liệu | Medium |

## FR-01.4 - Tạo yêu cầu đặt xe

| Test Case ID | Test Type | Test Scenario | Test Case | Preconditions | Test Steps | Test Data | Expected Status | Expected Result | Priority |
|---|---|---|---|---|---|---|---|---|---|
| TC-FR014-001 | Positive | Tạo yêu cầu hợp lệ | Tạo yêu cầu với đầy đủ thông tin | Khách hàng đã cung cấp thông tin đặt xe hợp lệ | 1. Nhập thông tin<br>2. Gửi yêu cầu | pickup + destination + vehicleType hợp lệ | 201 | Yêu cầu đặt xe được tạo thành công | High |
| TC-FR014-002 | Negative | Tạo yêu cầu với thông tin sai | Gửi yêu cầu có thông tin không hợp lệ | Khách hàng đang đặt xe | 1. Nhập dữ liệu sai<br>2. Gửi yêu cầu | vehicleType = "INVALID" | 400 | Hệ thống từ chối yêu cầu | High |
| TC-FR014-003 | Empty | Không có thông tin đặt xe | Gửi request rỗng | Khách hàng đang đặt xe | 1. Không nhập dữ liệu<br>2. Gửi yêu cầu | {} | 400 | Hệ thống yêu cầu nhập thông tin | High |
| TC-FR014-004 | Boundary | Thông tin đạt giới hạn cho phép | Gửi yêu cầu với dữ liệu ở giới hạn | Khách hàng đang đặt xe | 1. Nhập dữ liệu biên<br>2. Gửi yêu cầu | Dữ liệu tại giới hạn cho phép | 201 | Yêu cầu được tạo thành công | Medium |
| TC-FR014-005 | Error | Request sai cấu trúc | Gửi request không đúng JSON | Khách hàng đang đặt xe | 1. Gửi request sai cấu trúc<br>2. Kiểm tra kết quả | JSON không hợp lệ | 400 | Hệ thống trả về lỗi request | High |

## FR-01.5 - Kiểm tra thông tin đặt xe

| Test Case ID | Test Type | Test Scenario | Test Case | Preconditions | Test Steps | Test Data | Expected Status | Expected Result | Priority |
|---|---|---|---|---|---|---|---|---|---|
| TC-FR015-001 | Positive | Thông tin hợp lệ | Kiểm tra request có đầy đủ thông tin hợp lệ | Khách hàng đang đặt xe | 1. Nhập thông tin<br>2. Gửi kiểm tra | pickup + destination + vehicleType hợp lệ | 200 | Hệ thống xác nhận thông tin hợp lệ | High |
| TC-FR015-002 | Negative | Thông tin không hợp lệ | Kiểm tra request có dữ liệu sai | Khách hàng đang đặt xe | 1. Nhập dữ liệu sai<br>2. Gửi kiểm tra | pickup.address = "@@@###" | 400 | Hệ thống xác định thông tin không hợp lệ | High |
| TC-FR015-003 | Empty | Thiếu thông tin | Kiểm tra request không có điểm đi | Khách hàng đang đặt xe | 1. Bỏ trống pickup<br>2. Gửi kiểm tra | pickup = {} | 400 | Hệ thống yêu cầu bổ sung điểm đi | High |
| TC-FR015-004 | Boundary | Dữ liệu ở giới hạn | Kiểm tra thông tin tại giới hạn cho phép | Khách hàng đang đặt xe | 1. Nhập dữ liệu biên<br>2. Gửi kiểm tra | Dữ liệu ở giới hạn cho phép | 200 | Hệ thống chấp nhận dữ liệu | Medium |
| TC-FR015-005 | Error | Sai kiểu dữ liệu | Kiểm tra request có kiểu dữ liệu sai | Khách hàng đang đặt xe | 1. Gửi dữ liệu sai kiểu<br>2. Kiểm tra | pickup = 123 | 400 | Hệ thống trả về lỗi dữ liệu | Medium |

## FR-01.6 - Xem trạng thái yêu cầu

| Test Case ID | Test Type | Test Scenario | Test Case | Preconditions | Test Steps | Test Data | Expected Status | Expected Result | Priority |
|---|---|---|---|---|---|---|---|---|---|
| TC-FR016-001 | Positive | Yêu cầu tồn tại | Xem trạng thái một yêu cầu hợp lệ | Yêu cầu đặt xe đã tồn tại | 1. Nhập rideId<br>2. Xem trạng thái | rideId = "RIDE-001" | 200 | Hiển thị trạng thái yêu cầu | High |
| TC-FR016-002 | Negative | Yêu cầu không tồn tại | Xem trạng thái rideId không tồn tại | Người dùng có quyền xem trạng thái | 1. Nhập rideId<br>2. Xem trạng thái | rideId = "INVALID" | 404 | Hệ thống thông báo không tìm thấy yêu cầu | High |
| TC-FR016-003 | Empty | Không nhập mã yêu cầu | Bỏ trống rideId | Người dùng có quyền xem trạng thái | 1. Không nhập rideId<br>2. Gửi yêu cầu | rideId = "" | 400 | Hệ thống yêu cầu rideId | High |
| TC-FR016-004 | Boundary | rideId đạt giới hạn | Sử dụng rideId tại giới hạn độ dài | Người dùng có quyền xem trạng thái | 1. Nhập rideId<br>2. Gửi yêu cầu | rideId có độ dài tối đa | 200 | Hệ thống xử lý yêu cầu | Medium |
| TC-FR016-005 | Error | Sai định dạng rideId | Gửi rideId sai định dạng | Người dùng có quyền xem trạng thái | 1. Nhập rideId sai<br>2. Gửi yêu cầu | rideId = null | 400 | Hệ thống trả về lỗi dữ liệu | Medium |

## FR-01.7 - Hủy yêu cầu đặt xe

| Test Case ID | Test Type | Test Scenario | Test Case | Preconditions | Test Steps | Test Data | Expected Status | Expected Result | Priority |
|---|---|---|---|---|---|---|---|---|---|
| TC-FR017-001 | Positive | Hủy yêu cầu hợp lệ | Hủy yêu cầu đang ở trạng thái cho phép hủy | Yêu cầu tồn tại và được phép hủy | 1. Chọn yêu cầu<br>2. Chọn hủy<br>3. Xác nhận | rideId = "RIDE-001" | 200 | Yêu cầu được hủy thành công | High |
| TC-FR017-002 | Negative | Hủy yêu cầu không được phép | Hủy yêu cầu đã hoàn thành | Yêu cầu đã hoàn thành | 1. Chọn yêu cầu<br>2. Chọn hủy | status = "COMPLETED" | 400 | Hệ thống từ chối thao tác hủy | High |
| TC-FR017-003 | Empty | Không cung cấp rideId | Gửi yêu cầu hủy không có mã chuyến | Người dùng đang thực hiện hủy | 1. Không nhập rideId<br>2. Gửi yêu cầu | rideId = "" | 400 | Hệ thống yêu cầu mã chuyến | High |
| TC-FR017-004 | Boundary | Hủy tại thời điểm giới hạn | Hủy chuyến ngay tại thời điểm cuối được phép | Yêu cầu vẫn nằm trong thời gian cho phép hủy | 1. Chọn yêu cầu<br>2. Hủy | Thời gian = giới hạn cho phép | 200 | Hệ thống xử lý theo chính sách | Medium |
| TC-FR017-005 | Error | Yêu cầu không tồn tại | Hủy rideId không tồn tại | Người dùng có quyền hủy | 1. Nhập rideId<br>2. Gửi yêu cầu | rideId = "RIDE-999" | 404 | Hệ thống thông báo không tìm thấy chuyến | High |
